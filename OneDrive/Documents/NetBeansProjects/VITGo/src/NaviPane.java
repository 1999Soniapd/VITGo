...
public class NaviPane extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mentor = new javax.swing.JComboBox();
        ...
        jLabel12.setText("Mentor");

        hostel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "MH-1", "MH-2", "LH-1", " " }));
        ...
        mentor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "Prof. Susmitha", "Prof. Hussain ", " " }));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Already registered ! Go To Login");
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(regno, javax.swing.GroupLayout.DEFAULT_SIZE, 143, Short.MAX_VALUE)
                            .addComponent(email)
                            .addComponent(cpw)
                            .addComponent(uname)
                            ...
                            .addComponent(mentor, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(6, 6, 6)
...
//       }
 ...
 try
        ...
        String rno = roomnumber.getText();
        String mentorname = new String();
        int m = mentor.getSelectedIndex();
        if(m==1)
            mentorname = "Prof. Susmitha";
        else
            mentorname = "Prof. Hussain";
        
        String hblock = new String();
        int hb = hostel.getSelectedIndex();
        if(hb==1)
            hblock="MH-1";
        else if(hb==2)
            hblock = "MH-2";
        ...
        int c = 0;
        if(p1.equals(p2))
        {System.out.println("atleast passwords are correct");
            Statement st;
            try {
               ...
               // ResultSet num = st.executeQuery("select count(regno) from registration");
                ...
                {  System.out.println("in while");
                    ...
                    String query = "insert into register values ('"+un+"','"+reg+"','"+emailid+"','"+p1+"')";
                    System.out.println(query);
                ResultSet  rs2 = st.executeQuery("insert into register values ('"+un+"','"+reg+"','"+emailid+"','"+hblock+"','"+rno+"','"+mentorname+"','"+p1+"')");
                  if(rs2.next())
                  {System.out.println("executed");
                  this.setVisible(false);  
                  home h = new home();
                         h.setVisible(true);
                         h.displayName(un,reg);
                  }
                  else
...
email.setForeground(Color.BLACK);        // TODO add your handling code here:
    ...
    private javax.swing.JComboBox mentor;
